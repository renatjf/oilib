       ...
       <div className="header-oi">
        <nav className="menu container">
          <ul className="menu__items">
            ...
            <li className="menu__item__secondary extra-large-up menu__item extra-large-up">
              <a href="http://www.oismart.com.br/">Oi Smart</a>
            </li>
            <li className="menu__item__secondary menu__item__search medium-up menu__item">
            ...
            <li className="menu__minha-oi menu__item">
                <a href="http://www.oi.com.br/minha-oi/">Minha Oi</a>
            </li>
